...
<body id="page-top" data-bs-spy="scroll" data-bs-target="#mainNav" data-bs-offset="54">
    ...
    <nav class="navbar navbar-dark navbar-expand-lg fixed-top bg-dark" id="mainNav">
        <div class="container"><a class="navbar-brand" href="index.php">Stema</a>
		<button class="navbar-toggler navbar-toggler-right" data-bs-toggle="collapse" data-bs-target="#navbarResponsive" type="button" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation"><i class="fa fa-bars"></i></button>
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ms-auto text-uppercase">
                    ...
                    <li class="nav-item"><a class="nav-link" href="registration.php" style="background: rgb(163,145,84);font-size: 12.4px;border-radius: 28px;transform-origin: 38px 19px;width: 89px;margin-top: 5px;min-height: 0px;height: 40.6562px;text-align: center;font-weight: bold;border-width: 0px;border-color: rgb(255,255,255);">SIGN UP</a></li>
                </ul>
            </div>
        </div>
    </nav>
                    ...
                    <form id="loginForm" name="loginForm" novalidate="novalidate" method="POST" action="database/login.php">
                        <div class="row">
                            <div class="col-md-6 offset-xl-3" style="height: 256px;">
								<input class="form-control" type="email" id="email" placeholder="E-mail" required="" style="height: 66px;padding: 20px;" name="email" maxlength="50">
								...
								<div class="col-lg-12 text-center" style="height: 66px;padding: 20px; margin-top: 15px;">
									...
									<div id="logSucc" style="color:green"></div>
								</div>
							</div>
